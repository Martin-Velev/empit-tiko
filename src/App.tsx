...
export default function App() {
  ...
  return (
    <div className="App">
      <h1>Dear interviewee</h1>
      <h2>
        Implement the frontend. See comments marked with TODO in the code for
        more details. Please create a fork of this Codesandbox and proceed with
